...
Hard rules:
1. Do not change case_id, dataset_role, visit_type, question_id, question_type, dialect_type, dialect_intensity, symptom_group, gold_symptoms, negative_symptoms, status_pattern, expression_policy, difficulty, or surface_target.
...
10. If dialect_type is kangwon, use natural Gangwon-style colloquial flavor. Do not overuse rare dialect words.
