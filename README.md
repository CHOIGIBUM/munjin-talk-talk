...
- 고령층의 **59.6%**는 키오스크 이용 중 어려움을 겪은 적이 있다고 응답했으며, 그 이유로 뒷사람 눈치, 선택사항 적용 어려움, 용어 이해 어려움을 꼽았습니다. 의료 문진이 타이핑·키오스크 중심으로 설계될수록 고령 환자의 진입 장벽은 커집니다. ([연합뉴스 고령층 키오스크 이용 조사](https://www.yna.co.kr/view/AKR20240612056200004))
