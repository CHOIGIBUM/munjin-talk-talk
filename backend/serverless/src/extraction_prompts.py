...
- Generic discomfort, concern, frequency, timing, or worsening phrases such as "좀 불편해", "더 신경 쓰여", "더 자주", "왔다 갔다 반복돼", "밤에 더 불편해", "오후에 더 뚜렷해", or "누워 있어도 남아 있어" are clinical context, not standalone active symptoms.
- Phrases such as "기침하거나 움직이면 더 그래" describe an aggravating factor. Do not create a cough symptom unless cough itself is a current complaint, and do not create exertional dyspnea unless breathlessness with exertion is explicitly stated.
...
- Pain that "spreads", "radiates", or "extends" to the shoulder/arm should remain radiating pain even if the sentence also says it is uncomfortable or worse with movement/coughing.
- A pulse described as too fast, or a heart described as 빠르게/rapid/racing, is tachycardia. The colloquial phrase "심장이 빨리 뛰는 느낌" should be treated as palpitation unless a measured pulse, pulse rate, or explicit tachycardia wording is stated.
...
- Facial paleness, pale complexion, or looking pale is pallor.
- Eye crust, eye discharge, or sticky eye mucus is eye discharge, not heavy eyes.
...
- In follow-up or medication answers, a symptom that "있었어" after the last visit or while taking medication is an interval/current complaint unless the patient also says it resolved.
- In "사레가 잘 들어" or "사래가 잘 들어", "잘 들어" means choking/aspiration happens easily or often; do not treat it as improved.
